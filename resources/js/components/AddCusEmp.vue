        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Employee Customer</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="customer_id">select customers</label>
                        <select multiple="" class="form-control" id="customer_id"
                                v-model="customer_id"
                        >
                            <option v-for="customer of customers" :key="customer.customer_id"
                                    name="prospect_id"
...
export default {
    ...
    methods: {
        add() {
            axios.post('http://localhost/crm-project/public/cusEmp/store', {
