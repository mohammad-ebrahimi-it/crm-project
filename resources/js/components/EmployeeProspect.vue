<template>
    <div>
        <div id="container-wrapper" class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between"><h6
                            class="m-0 font-weight-bold text-primary">DataTables Employee Prospect</h6></div>
                                        ...
                                        <table id="dataTableHover" role="grid" aria-describedby="dataTableHover_info"
                                            ...
                                            <tr role="row">
                                                ...
                                                <th tabindex="0" aria-controls="dataTableHover" rowspan="1" colspan="1"
                                                    ...
                                                    style="width: 54.6333px;">Name Prospect
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1">Name Prospect</th>
            ...
            <!-- Modal -->
            <div id="model">
                <AddEmpPros @insertData="refreshCustomer"></AddEmpPros>
            </div>
        </div>
...
export default {
    ...
    created() {
        axios
            .get('http://localhost/crm-project/public/empPros/get')
            .then((response) => {
